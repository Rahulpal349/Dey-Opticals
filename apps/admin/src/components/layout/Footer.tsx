      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-12">
          ...
          <div className="flex flex-col gap-4">
            <div className="flex items-center gap-3">
              ...
              <span className="font-serif text-2xl font-bold text-gray-900">Dey Opticals</span>
            </div>
            <p className="text-gray-600 text-sm leading-relaxed">
              Caring for your eyes with quality and trust
            </p>
          ...
          {/* Shop Links */}
          <div>
            <h3 className="font-heading font-semibold text-lg mb-4 text-primary">Shop</h3>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                { name: 'Home Eye Test', href: '/home-eye-test' },
          ...
          {/* Locations */}
          <div>
            <h3 className="font-heading font-semibold text-lg mb-4 text-primary">Locations</h3>
            <div className="flex flex-col gap-4">
              <div className="flex gap-3 items-start text-sm text-gray-600">
                <MapPin className="text-primary w-5 h-5 shrink-0 mt-0.5" />
                <div>
                  <p className="text-gray-900 font-medium">Main Store</p>
                  <p>Stall No-15, Near Beliatore Gram Panchayat,<br />Beliatore, Barjora, West Bengal 722203</p>
                </div>
              </div>
              <div className="flex gap-3 items-start text-sm text-gray-600">
        ...
        <div className="border-t pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-gray-500 text-sm">
            © {new Date().getFullYear()} Dey Opticals. All rights reserved.
          </p>
          <div className="flex gap-4">
            <Link href="/privacy-policy" className="text-gray-500 hover:text-primary text-sm">Privacy Policy</Link>
